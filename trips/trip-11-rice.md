...
────────────────────────────────────────────────────────────────
  Opponent    : Rice Owls
  Date        : Saturday, November 28, 2026  🦃 Thanksgiving Weekend
  Kickoff     : TBD
  Stadium     : Rice Stadium, Houston, TX
  Location    : Houston, Texas (Rice University / Museum District)
...
────────────────────────────────────────────────────────────────
  ...
  Route       : DFW → Houston, TX via I-45 S
  Distance    : ~240 miles
...
────────────────────────────────────────────────────────────────
  ...
  - 3-night stay allows a true Thanksgiving weekend experience
    in Houston — Museum District, restaurants, Hermann Park
  - Depart Sunday before noon to beat post-holiday traffic
