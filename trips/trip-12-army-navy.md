...
────────────────────────────────────────────────────────────────
  ...
  Location    : East Rutherford, New Jersey (NYC metro)
  Game Type   : 127th Army-Navy Game | HIGHEST PRIORITY
...
────────────────────────────────────────────────────────────────
  - ★ BOOK HOTEL NOW — do not wait. MetLife Army-Navy weekend
    fills faster than any other trip on this schedule.
  - [P1] HIGHEST PRIORITY — use nonstop flights only for this
    game. Missing a connection is not acceptable.
  - Purchase game tickets through Army's official alumni/fan
